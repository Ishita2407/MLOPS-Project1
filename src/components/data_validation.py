...
class DataValidation:
    ...
    def is_column_exist(self, df: DataFrame) -> bool:
        ...
        try:
            ...
            # checking for numerical missing columns
            # and saving those columns in missing_numerical_columns list
            ...
            # and saving those columns in missing_categorical_columns list
